...
show_usage() {
    ...
    echo "Changes:"
    echo "  --l1-rpc-urls from http://65.109.116.87:8545 to http://213.232.207.218:8546"
    echo "  --l1-consensus-host-urls from http://65.109.116.87:5052 to http://213.232.207.218:5053"
...
main() {
    ...
    log "Updated L1 RPC URL: http://65.109.116.87:8545 -> http://213.232.207.218:8546"
    log "Updated L1 Consensus URL: http://65.109.116.87:5052 -> http://213.232.207.218:5053"
